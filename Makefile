...
cert.key: Makefile
	rm -Rf '$@'
	openssl req -x509 -newkey rsa:2048 -nodes -days 7 -keyout cert.key -out cert.crt -extensions v3_req -subj '/C=US/O=UFOCTF/OU=Heartbleed/CN=$(HOSTNAME)'
	chmod go-wx '$@'
